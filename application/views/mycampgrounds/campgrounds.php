<h2>Your Campgrounds</h2>
<button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Campground</button>
<?php
// print_r($camps);
...
<div class="modal fade" id="editModal" role="dialog">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form class="" action="<?php echo site_url('mycampgrounds/updateCampground'); ?>" method="post">
                        <div class="form-group">
